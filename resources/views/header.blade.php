			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a><i class="fa fa-home"></i> 137 Phong Phu Street District 8 Ho Chi Minh City</a></li>
						<li><a><i class="fa fa-phone"></i> 090 312 8477</a></li>
					</ul>
				</div>
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="{{route('search')}}">
					        <input type="text" value="" name="key" id="s" placeholder="Input book name..." />
						...
						<div class="cart">
							...
							@endforeach
								<div class="cart-caption">
									<div class="cart-total text-right">Total: <span class="cart-total-value">@if(Session::has('cart')){{number_format($totalPrice)}} @else 0 @endif VNĐ</span></div>
									<div class="clearfix"></div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('loaisanpham',1)}}">Book type</a>
							<ul class="sub-menu">
